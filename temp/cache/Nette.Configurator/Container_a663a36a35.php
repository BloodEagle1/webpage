<?php
// source: C:\wamp\www\web\app/config/config.neon 
// source: C:\wamp\www\web\app/config/config.local.neon 

class Container_a663a36a35 extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\wamp\www\web\app',
			'wwwDir' => 'C:\wamp\www\web\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\wamp\www\web\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\wamp\www\web\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\wamp\www\web\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\wamp\www\web\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_a663a36a35_IPub_FlashMessages_Components_IControlImpl_flashMessages_messages($this);
	}
	...
	{
		return new Container_a663a36a35_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\wamp\www\web\app/../temp/cache/latte');
...
final class Container_a663a36a35_IPub_FlashMessages_Components_IControlImpl_flashMessages_messages implements IPub\FlashMessages\Components\IControl
{
	private $container;


	public function __construct(Container_a663a36a35 $container)
	{
...
final class Container_a663a36a35_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;

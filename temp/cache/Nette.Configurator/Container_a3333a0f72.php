...
class Container_a3333a0f72 extends Nette\DI\Container
{
	...
	{
		return new Container_a3333a0f72_IPub_FlashMessages_Components_IControlImpl_flashMessages_messages($this);
	}
	...
	{
		return new Container_a3333a0f72_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_a3333a0f72_IPub_FlashMessages_Components_IControlImpl_flashMessages_messages implements IPub\FlashMessages\Components\IControl
{
	private $container;


	public function __construct(Container_a3333a0f72 $container)
	{
...
final class Container_a3333a0f72_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;

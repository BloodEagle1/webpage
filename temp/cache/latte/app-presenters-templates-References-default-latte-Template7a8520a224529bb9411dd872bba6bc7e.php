<?php
// source: C:\wamp\www\bakalarka_web\app\presenters/templates/References/default.latte

class Template7a8520a224529bb9411dd872bba6bc7e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('12eda9a3c6', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb254d206aa7_title')) { function _lb254d206aa7_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Referencie<?php
}}
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbb70b5f6b1d_content')) { function _lbb70b5f6b1d_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="container">
    <div class="row">
        <div class="box">
            <div class="col-lg-12">
...
/<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->imgUrl), ENT_COMPAT) ?>" class="mImg">        
                            </a>
                        </div>
<?php } $iterations++; } ?>
                    </div>

<?php
// source: C:\wamp\www\bakalarka_web\app\presenters/templates/Homepage/default.latte

class Templatea269c868a985ffb881c39eaf75b02e29 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ad477f34e0', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb347fa64f0f_title')) { function _lb347fa64f0f_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Úvod<?php
}}
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb9e5266ab0e_content')) { function _lb9e5266ab0e_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="container">
...
<?php $iterations = 0; foreach ($galery as $img) { ?>
                                <a href="http://localhost/bakalarka_web/www/reference/?referenceId=<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->reference_id), ENT_COMPAT) ?>
"> <?php if ($img->homeImg == 1) { ?><img class="img-responsive img-full" src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>
/<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->imgUrl), ENT_COMPAT) ?>
" alt=""><?php } ?>
</a>
<?php $iterations++; } ?>
                        </div>
...
<?php $iterations = 0; foreach ($galery as $img) { ?>
                                <a href="http://localhost/bakalarka_web/www/reference/?referenceId=<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->reference_id), ENT_COMPAT) ?>
"><?php if ($img->homeImg == 2) { ?><img class="img-responsive img-full" src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>
/<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->imgUrl), ENT_COMPAT) ?>
" alt=""><?php } ?>
</a>
<?php $iterations++; } ?>
...
<?php $iterations = 0; foreach ($galery as $img) { ?>
                                <a href="http://localhost/bakalarka_web/www/reference/?referenceId=<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->reference_id), ENT_COMPAT) ?>
"><?php if ($img->homeImg == 3) { ?><img class="img-responsive img-full" src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>
/<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->imgUrl), ENT_COMPAT) ?>
" alt=""><?php } ?>
</a>
<?php $iterations++; } ?>
...
/<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->imgUrl), ENT_COMPAT) ?>" id="galeryImg" class="responsive">
<?php } ?>
                        </a>
<?php } ?>
                    </div>

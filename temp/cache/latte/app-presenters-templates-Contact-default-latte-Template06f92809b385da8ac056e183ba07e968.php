<?php
// source: C:\wamp\www\bakalarka_web\app\presenters/templates/Contact/default.latte

class Template06f92809b385da8ac056e183ba07e968 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('81d551d38f', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbc767e827e2_title')) { function _lbc767e827e2_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Kontakt<?php
}}
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb1c25a742b1_content')) { function _lb1c25a742b1_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="container">
    <div class="row">
        <div class="box">
            <div class="col-lg-12">

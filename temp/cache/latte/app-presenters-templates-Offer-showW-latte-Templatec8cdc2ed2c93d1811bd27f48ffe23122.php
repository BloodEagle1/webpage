<?php
// source: C:\wamp\www\bakalarka_web\app\presenters/templates/Offer/showW.latte

class Templatec8cdc2ed2c93d1811bd27f48ffe23122 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a3c0f576e9', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb58bb5c47c0_content')) { function _lb58bb5c47c0_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="container">
    <div class="row">
        <div class="box">
            <div class="col-lg-12">

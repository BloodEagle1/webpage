<?php
// source: C:\wamp\www\web\app\presenters/templates/Reference/default.latte

class Template9331637100f47e9c321323eccfdc5df4 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('e50defb8e6', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb9c8a6680fb_title')) { function _lb9c8a6680fb_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>Referencia<?php
}}
...
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb54a1a02eed_content')) { function _lb54a1a02eed_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="container">
    <div class="row">
        <div class="box">
...
">← späť na výpis referencií</a></p>
            <div class="col-lg-12">
                <hr>
                <h2 class="intro-text text-center"><?php echo Latte\Runtime\Filters::escapeHtml($reference->title, ENT_NOQUOTES) ?></h2>
                <hr>
                <h2>
...
id="galeryGroupL" <?php } ?> id="galeryGroup">
                        <div>
                            <a href="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ;echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->imgUrl), ENT_COMPAT) ?>" data-lightbox="lalal">
                                <img src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ;echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($img->imgUrl), ENT_COMPAT) ?>" id="galeryImg" alt="">
                            </a>
                        </div>
                        <div>

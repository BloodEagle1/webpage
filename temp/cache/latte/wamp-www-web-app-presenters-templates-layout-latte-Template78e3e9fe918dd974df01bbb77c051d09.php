<?php
// source: C:\wamp\www\web\app\presenters/templates/@layout.latte

class Template78e3e9fe918dd974df01bbb77c051d09 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('a8e371ccff', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb99d2309b1c_head')) { function _lb99d2309b1c_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbee221118f6_scripts')) { function _lbee221118f6_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
